...
I volumes permettono di mantenere i dati persistenti, anche se il contenitore viene ricreato. In questo esempio, aggiungiamo un volume per mappare i file dell'app locale all'interno del contenitore, così possiamo sviluppare l'app in tempo reale senza dover ricostruire il contenitore.
