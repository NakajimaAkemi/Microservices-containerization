...
### Secrets
Secrets are used to store sensitive information(e.g., API keys, passwords), they are designed to be tightly controlled, secure and only accessible to containers that you specify.
