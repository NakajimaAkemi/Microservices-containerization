...
As prerequisite we need to have an Account on a **Docker registry service**, **AWS ECR**, **Google Container Registry** or other. In this case we will show how it works with **Docker hub**.
