...
public class Task {
    ...
    public Task(String name, String description, LocalDate dueDate, ProjectP project, TaskStatus status) {
        this.name = name;
    ...
    public Task(String name, String description, LocalDate dueDate, ProjectP project) {
    ...
    public ProjectP getProjectP() {
        return project;
    }

    public void setProjectP(ProjectP project) {
        this.project = project;
    }
