...
The `CMD` instruction specifies the command that will run when the container starts, tipically it's written following the format `CMD ["executable","param1","param2"]` also referenced as **exec form**.
