...
> [!IMPORTANT]
> Choosing the base image of our container is an important step, find the one that provides what you need and obviously stick to trusted and officila distibutors.
____
#### 2. `COPY`
